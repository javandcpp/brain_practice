    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.txtvhelp)).setText(Html.fromHtml(this.readTxt(), new Html.ImageGetter() {
            public Drawable getDrawable(String source) {
                Drawable v1;
                try {
                    v1 = Ayuda.this.getResources().getDrawable(Ayuda.this.getResources().getIdentifier(
                            source, "drawable", "com.mandalas.manadalas.coloring"));
                    v1.setBounds(0, 0, v1.getIntrinsicWidth(), v1.getIntrinsicHeight());
                }
                catch(Exception v2) {
                    Drawable v0 = Ayuda.this.getResources().getDrawable(R.drawable.ic_launcher);
...
//            v0.setFlags(268435456);
    ...
    private String readTxt() {
        InputStream v3 = this.getResources().openRawResource(this.getResources().getIdentifier("com.mandalas.manadalas.coloring:raw/help", 
                null, null));
