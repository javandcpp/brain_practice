...
public class Aboutshapes extends Activity {
    public Aboutshapes() {
        super();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.txtvhelp)).setText(Html.fromHtml(this.readTxt(), new Html.ImageGetter() {
            public Drawable getDrawable(String source) {
                Drawable v1;
                try {
                    v1 = Aboutshapes.this.getResources().getDrawable(Aboutshapes.this.getResources()
                            .getIdentifier(source, "drawable", "com.mandalas.manadalas.coloring"));
                    v1.setBounds(0, 0, v1.getIntrinsicWidth(), v1.getIntrinsicHeight());
                }
                catch(Exception v2) {
                    Drawable v0 = Aboutshapes.this.getResources().getDrawable(R.drawable.ic_launcher);
    ...
    private String readTxt() {
        InputStream v3 = this.getResources().openRawResource(this.getResources().getIdentifier("com.mandalas.manadalas.coloring:raw/aboutshapes", 
                null, null));
