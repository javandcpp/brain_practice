...
public class ImagePracticeRightAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (null == view) {
            ...
            view = LayoutInflater.from(GlobalApplication.instance).inflate(R.layout.image_practice_right_item_layout, null);
