...
public class RemberPracticeEnterAdapter extends BaseAdapter {

    public List<RemberPracticeResult.Practice> tempList = new ArrayList<>();
    private ViewHolder viewHolder;

    public RemberPracticeEnterAdapter(List<RemberPracticeResult.Practice> dataList) {
